  ...
  return (
    ...
    <div className="flex flex-col gap-[20px] w-full">
      <div className="flex items-center gap-2">
        ...
        <p className="text-[#475467] font-medium text-sm">مسابقاتي</p>
        <ChevronLeftRounded className="text-[#E3E3E4]" />
        <div className="bg-[#EEEEEF] px-2 py-1 rounded-md">
          <p className="text-[#344054] text-sm font-semibold">تفاصيل المسابقة</p>
        </div>
      </div>
      <h2 className="font-semibold text-[30px] text-shadeBlack">تفاصيل المسابقة</h2>
      <hr />
    </div>
  );
};
